...
import { FaDollarSign, FaShoppingCart, FaServer, FaUser, FaShieldAlt, FaEnvelope, FaInfoCircle, FaTrash } from 'react-icons/fa'
...
const CardsSection: React.FC<CardsSectionProps> = ({ addBalance, renewPlan, balance, activePlans, dataLeft, totalDataPurchased, username, userId }) => {
		...
		<div className="container cards-section">
			...
			<div className="d-flex justify-content-between align-items-center mb-4">
				...
				<button className="btn btn-light shadow-sm read-more-btn">
					<FaShieldAlt className="me-2" /> Residential State/City Targeting <span>Read More &gt;</span>
				</button>
			</div>
