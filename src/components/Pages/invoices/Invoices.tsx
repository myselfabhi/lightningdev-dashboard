  ...
  return (
    <DashboardLayout>
      <div className="invoices-container">
        ...
        <div className="controls p-3 d-flex justify-content-between align-items-center">
          ...
          <div className="filter-buttons d-flex align-items-center">
            ...
            <button
              className={`chip-btn chip-red me-2 ${filter === 'Unpaid' ? 'chip-active' : ''}`}
              onClick={() => setFilter('Unpaid')}
            >
              Unpaid
            </button>
            <button
              className={`chip-btn chip-green ${filter === 'Paid' ? 'chip-active' : ''}`}
        ...
        {/* Invoices Table */}
        <div className="table-container mt-3 p-3 rounded">
                ...
                filteredInvoices.map((invoice) => (
                  <tr key={invoice.id}>
                    ...
                    <td>
                      <span
                        className={`chip ${
                          invoice.paymentStatus === 'Paid' ? 'chip-success' : 'chip-danger'
                        }`}
                      >
