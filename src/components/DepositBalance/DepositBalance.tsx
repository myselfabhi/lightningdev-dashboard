    ...
    <div className="deposit-balance-container container">
      <div className="d-flex justify-content-between align-items-start">
        ...
        <div className="balance-input-section">
          ...
          <div className="mb-4">
            <div className="mb-3">
              <input type="number" className="balance-input" placeholder="$0.00" />
        ...
        <div className="balance-info-section text-center">
          ...
          <div className="benefits-section mt-4">
            ...
            <p>
              Adding balance via top-up has several advantages for regular users. Hassle of going through wallets and
              network confirmations is completely removed for future purchases.
            </p>
