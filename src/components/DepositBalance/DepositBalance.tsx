			...
			<div className="d-flex justify-content-between align-items-start">
				...
				<div className="balance-input-section">
					...
					<div className="balance-form mb-4">
						<div className="mb-3">
							<input type="number" className="form-control balance-input" placeholder="$0.00" />
							<span className="stripe-vat">Stripe VAT (0%)</span>
						</div>
						<button className="btn btn-success w-100 mb-2">Add Balance using Cryptocurrency</button>
						<button className="btn btn-primary w-100">Add Balance using Stripe</button>
					</div>
					...
					<div className="footer-logos mt-4 d-flex align-items-center">
						<img src="/cryptomus.svg" alt="Cryptomus" className="footer-logo me-2" />
				...
				<div className="balance-info-section text-center">
					...
					<img src="https://lightningproxies.net/assets/images/vector.svg" alt="Deposit Illustration" className="illustration-image" />
					<div className="benefits-section mt-4">
						<h6>Benefits to adding Account Balance</h6>
						<p>Adding balance via top-up has several advantages for regular users. Hassle of going through wallets and network confirmations is completely removed for future purchases.</p>
