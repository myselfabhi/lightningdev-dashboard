	...
	return (
		<aside className="sidebar-wrapper">
			...
			<div className="logo-box">
				<img src="https://lightningproxies.net/assets/images/logo.svg" alt="Lightning Proxies Logo" className="logo" />
			...
			<div className="extension-section">
				...
				<div className="extension-header">
					<img src="https://lightningproxies.net/assets/images/logo.svg" alt="LightningProxies Logo" className="extension-logo" />
					<span className="extension-title">LightningProxies Extension</span>
				</div>
				<p className="extension-description">A proxy extension enhances online privacy by routing traffic through an intermediary server.</p>
				<button className="extension-btn">
					<img src="https://lightningproxies.net/assets/images/chrome.svg" alt="Chrome Icon" className="chrome-icon" />
					Add to Chrome
				</button>
			</div>
				...
				<ul className="social-icons">
					<li>
						<a href="https://discord.com/" target="_blank" rel="noopener noreferrer">
							<img src="https://lightningproxies.net/assets/images/sidebar-icons/social-03.svg" alt="Discord" className="social-icon" />
						</a>
					</li>
					<li>
						<a href="https://telegram.org/" target="_blank" rel="noopener noreferrer">
							<img src="https://lightningproxies.net/assets/images/sidebar-icons/social-01.svg" alt="Telegram" className="social-icon" />
						</a>
					</li>
				</ul>
			</div>
